...
class SlidersController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            // Flutter app mengharapkan array langsung di dalam 'sliders'
            $sliderImages = $sliders->map(function ($slider) {
                return $this->formatImageUrl($slider->image_url);
    ...
    /**
     * Format slider data untuk mobile app (camelCase)
     * 
     * @param Slider $slider
     * @return array
     */
    private function formatSlider(Slider $slider): array
    {
        return [
            'id' => (string) $slider->id,
            'imageUrl' => $this->formatImageUrl($slider->image_url),
        ];
    }
